            ...
            categories: vec![
                SourceCategory {
                    ...
                    base_sites: vec![
                        ...
                        "sciencemag.org".to_string(),
                        "mit.edu".to_string(),
                        "phys.org".to_string(),
                        "semanticscholar.org".to_string(),
                        "core.ac.uk".to_string(),
                        "paperswithcode.com".to_string(),
                        "base-search.net".to_string(),
                        "doaj.org".to_string(),
                        "worldscientific.com".to_string(),
                    ],
                    enabled: true,
                },
                SourceCategory {
                    ...
                    base_sites: vec![
                        ...
                        "web.dev".to_string(),
                        "smashingmagazine.com".to_string(),
                        "martinfowler.com".to_string(),
                        "infoq.com".to_string(),
                        "dzone.com".to_string(),
                        "freecodecamp.org".to_string(),
                        "digitalocean.com".to_string(),
                        "realpython.com".to_string(),
                        "css-tricks.com".to_string(),
                    ],
                    enabled: true,
                },
                SourceCategory {
                    ...
                    base_sites: vec![
                        ...
                        "engadget.com".to_string(),
                        "wired.com".to_string(),
                        "venturebeat.com".to_string(),
                        "cnet.com".to_string(),
                        "mashable.com".to_string(),
                        "gizmodo.com".to_string(),
                        "zdnet.com".to_string(),
                        "tomshardware.com".to_string(),
                        "anandtech.com".to_string(),
                        "bleepingcomputer.com".to_string(),
                        "theregister.com".to_string(),
                        "9to5mac.com".to_string(),
                        "androidauthority.com".to_string(),
                        "techradar.com".to_string(),
                        "fastcompany.com".to_string(),
                        "g1.globo.com".to_string(),
                        "techtudo.com.br".to_string(),
                    ],
                    enabled: true,
                },
                SourceCategory {
                    ...
                    base_sites: vec![
                        ...
                        "forbes.com".to_string(),
                        "investopedia.com".to_string(),
                        "seekingalpha.com".to_string(),
                        "infomoney.com.br".to_string(),
                        "valor.globo.com".to_string(),
                        "exame.com".to_string(),
                        "braziljournal.com".to_string(),
                        "coindesk.com".to_string(),
                        "cointelegraph.com".to_string(),
                        "moneytimes.com.br".to_string(),
                        "suno.com.br".to_string(),
                        "b3.com.br".to_string(),
                        "imf.org".to_string(),
                    ],
                    enabled: true,
